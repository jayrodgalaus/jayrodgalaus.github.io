  ...
  <body onload="checkResize();">
    ...
    <div id="page">
      <div id="header">
        ...
        <div id="company_text"><h1 class="orange">NETWORK SECURITY POLICY.</h1></div>
      ...
      <div id="content">
        ...
        <h1 class="orange">Content blocked</h1>

        <div class="line">
          <div class="label">While trying to retrieve the URL:</div>
          <div class="desc">
            <span>http://ds-aksb-a.akamaihd.net/aksb.min.js<span>
          </div>
        </div>

        <div class="line">
          <div class="label">The content is blocked due to the following condition:</div>
          <div class="desc">
        ...
        <div class="line">
          ...
          <div class="desc">
            Blocked Category (Content Server)
          </div>
        </div>
          ...
          <div id="override">
            <div class="button">
              ...
              <div class="button_center">
                <a class="orange" href="https://passthrough.fw-notify.net/static/auth_override.html?category=177&return=http://ds-aksb-a.akamaihd.net/aksb.min.js">Unblock URL (will be logged)</a>
              </div>
